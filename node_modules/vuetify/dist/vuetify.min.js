...
function T(e){const[t,a]=E(e,[_]),l=I(t,A),[n,o]=E(a,["class","style","id",/^data-/])
...
const{ssrBootStyles:S}=_l(),{layoutItemStyles:k}=ea({id:e.name,order:t.computed(()=>parseInt(e.order,10)),position:t.toRef(()=>e.location),layoutSize:w,elementSize:t.shallowRef(void 0),active:r,absolute:t.toRef(()=>e.absolute)})
return Bt(()=>{const a=El.filterProps(e)
return t.createVNode(El,t.mergeProps({ref:o,class:["v-app-bar",{"v-app-bar--bottom":"bottom"===e.location},e.class],style:[{...k.value,"--v-toolbar-image-opacity":V.value,height:void 0,...S.value},e.style]},a,{collapse:y.value,flat:b.value}),n)}),{}}}),Rl=[null,"default","comfortable","compact"],Tl=vt({density:{type:String,default:"default",validator:e=>Rl.includes(e)}},"density")
...
return{colorClasses:n,colorStyles:o,variantClasses:l}}const zl=vt({baseColor:String,divided:Boolean,direction:{type:String,default:"horizontal"},...wl(),...pt(),...Tl(),...kl(),...pl(),...Pa(),...ya(),...$l()},"VBtnGroup"),Ll=wt()({name:"VBtnGroup",props:zl(),setup(e,a){let{slots:l}=a
...
Tn(e,t,Nn(t.oldValue))}},Fn=vt({active:{type:Boolean,default:void 0},activeColor:String,baseColor:String,symbol:{type:null,default:Ul},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Dt,appendIcon:Dt,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,spaced:String,ripple:{type:[Boolean,Object],default:!0},text:{type:[String,Number,Boolean],default:void 0},...wl(),...pt(),...Tl(),...ol(),...kl(),...jl(),...cn(),...nn(),...mn(),...pl(),...yn(),...Xl(),...Pa({tag:"button"}),...ya(),...$l({variant:"elevated"})},"VBtn"),$n=wt()({name:"VBtn",props:Fn(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return Bt(()=>t.createVNode(Ra,t.mergeProps(e,{class:"v-app-bar-title"}),l)),{}}}),On=St("v-alert-title"),jn=vt({iconSize:[Number,String],iconSizes:{type:Array,default:()=>[["x-small",10],["small",16],["default",24],["large",28],["x-large",32]]}},"iconSize")
function Hn(e,a){return{iconSize:t.computed(()=>{const t=new Map(e.iconSizes),l=e.iconSize??a()??"default"
return t.has(l)?t.get(l):l})}}const Wn=["success","info","warning","error"],Yn=vt({border:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["top","end","bottom","start"].includes(e)},borderColor:String,closable:Boolean,closeIcon:{type:Dt,default:"$close"},closeLabel:{type:String,default:"$vuetify.close"},icon:{type:[Boolean,String,Function,Object],default:null},modelValue:{type:Boolean,default:!0},prominent:Boolean,title:String,text:String,type:{type:String,validator:e=>Wn.includes(e)},...pt(),...Tl(),...ol(),...kl(),...jn(),...nn(),...mn(),...pl(),...Pa(),...ya(),...$l({variant:"flat"})},"VAlert"),Un=wt()({name:"VAlert",props:Yn(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return Bt(()=>t.createElementVNode("label",{class:t.normalizeClass(["v-label",{"v-label--clickable":!!e.onClick},e.class]),style:t.normalizeStyle(e.style),onClick:e.onClick},[e.text,l.default?.()])),{}}}),Zn=Symbol.for("vuetify:selection-control-group"),Qn=vt({color:String,disabled:{type:Boolean,default:null},defaultsTarget:String,error:Boolean,id:String,inline:Boolean,falseIcon:Dt,trueIcon:Dt,ripple:{type:[Boolean,Object],default:!0},multiple:{type:Boolean,default:null},name:String,readonly:{type:Boolean,default:null},modelValue:null,type:String,valueComparator:{type:Function,default:kt},...pt(),...Tl(),...ya()},"SelectionControlGroup"),Jn=vt({...Qn({defaultsTarget:"VSelectionControl"})},"VSelectionControlGroup"),eo=wt()({name:"VSelectionControlGroup",props:Jn(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
n&&l.push(...n)}}}}})}const So=vt({...ho(),...I(lo(),["inline"])},"VCheckbox"),ko=wt()({name:"VCheckbox",inheritAttrs:!1,props:So(),emits:{"update:modelValue":e=>!0,"update:focused":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
function Bo(){return{container:void 0,duration:300,layout:!1,offset:0,easing:"easeInOutCubic",patterns:It}}function Do(e){return"string"==typeof e?document.querySelector(e):S(e)}function Fo(e,t,a){if("number"==typeof e)return t&&a?-e:e
let l=Do(e),n=0
...
function _(e){I||S.value||e.relatedTarget&&g.el?.contains(e.relatedTarget)||T(),I=!1}function P(){I=!0}function A(e){function t(t){e.preventDefault(),T(t)}g.el&&(p.value?"ArrowRight"===e.key?t(n.value?"prev":"next"):"ArrowLeft"===e.key&&t(n.value?"next":"prev"):"ArrowDown"===e.key?t("next"):"ArrowUp"===e.key&&t("prev"),"Home"===e.key?t("first"):"End"===e.key&&t("last"))}function R(e,t){if(!e)return
let a=e
...
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-list-item-subtitle",e.class]),style:t.normalizeStyle([{"--v-list-item-subtitle-opacity":e.opacity},e.style])},l)),{}}}),wr=St("v-list-item-title"),Sr=vt({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Dt,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Dt,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,prependGap:[Number,String],subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},value:null,onClick:Z(),onClickOnce:Z(),...wl(),...pt(),...Tl(),...ol(),...kl(),...pl(),...yn(),...Pa(),...ya(),...$l({variant:"text"})},"VListItem"),kr=wt()({name:"VListItem",directives:{vRipple:Dn},props:Sr(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:r}=a
const i=hn(e,l),s=t.computed(()=>void 0===e.value?i.href.value:e.value),{activate:u,isActivated:c,select:d,isOpen:v,isSelected:p,isIndeterminate:m,isGroupActivator:f,root:g,parent:h,openOnSelect:y,id:V}=fr(s,()=>e.disabled,!1),w=ar(),S=t.computed(()=>!1!==e.active&&(e.active||i.isActive?.value||(g.activatable.value?c.value:p.value))),k=t.toRef(()=>!1!==e.link&&i.isLink.value),x=t.computed(()=>!!w&&(g.selectable.value||g.activatable.value||null!=e.value)),N=t.computed(()=>!e.disabled&&!1!==e.link&&(e.link||i.isClickable.value||x.value)),C=t.computed(()=>w?k.value?"link":x.value?"option":"listitem":void 0),E=t.computed(()=>{if(x.value)return g.activatable.value?c.value:g.selectable.value?p.value:S.value}),I=t.toRef(()=>e.rounded||e.nav),_=t.toRef(()=>e.color??e.activeColor),P=t.toRef(()=>({color:S.value?_.value??e.baseColor:e.baseColor,variant:e.variant}))
...
const{themeClasses:R}=Ca(e),{borderClasses:T}=Sl(e),{colorClasses:B,colorStyles:D,variantClasses:F}=Ml(P),{densityClasses:$}=Bl(e),{dimensionStyles:M}=rl(e),{elevationClasses:z}=xl(e),{roundedClasses:L}=ml(I),O=t.toRef(()=>e.lines?`v-list-item--${e.lines}-line`:void 0),j=t.toRef(()=>void 0!==e.ripple&&e.ripple&&w?.filterable?{keys:["Enter"]}:e.ripple),H=t.computed(()=>({isActive:S.value,select:d,isOpen:v.value,isSelected:p.value,isIndeterminate:m.value}))
...
return l.header?l.header({props:r}):t.createVNode(kr,r,s)},default:()=>t.createVNode(Er,{items:n,returnObject:e.returnObject},l)}):l.item?l.item({props:o}):t.createVNode(kr,t.mergeProps(o,{value:e.returnObject?i:o.value}),s)})}}),Ir=vt({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},itemType:{type:[Boolean,String,Array,Function],default:"type"},returnObject:Boolean,valueComparator:Function},"list-items"),_r=new Set(["item","divider","subheader"])
...
e||(e=[],t.set(n.value,e)),e.push(n)}else l.push(n)}n.value=t,o.value=l}),{items:a,transformIn:function(t){const r=n.value,i=a.value,s=o.value,u=l.value,c=e.returnObject,d=!!e.valueComparator,v=e.valueComparator||kt,p=C(e,Pr.neededProps),m=[]
...
return a}function Fr(e){return{items:t.computed(()=>Dr(e,e.items))}}const $r=vt({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,filterable:Boolean,expandIcon:Dt,collapseIcon:Dt,lines:{type:[Boolean,String],default:"one"},slim:Boolean,prependGap:[Number,String],indent:[Number,String],nav:Boolean,"onClick:open":Z(),"onClick:select":Z(),"onUpdate:opened":Z(),...pr({selectStrategy:"single-leaf",openStrategy:"list"}),...wl(),...pt(),...Tl(),...ol(),...kl(),...Ir(),...pl(),...Pa(),...ya(),...$l({variant:"text"})},"VList"),Mr=wt()({name:"VList",props:$r(),emits:{"update:selected":e=>!0,"update:activated":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:activate":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l}=a
const{items:n}=Fr(e),{themeClasses:o}=Ca(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl(()=>e.bgColor),{borderClasses:s}=Sl(e),{densityClasses:u}=Bl(e),{dimensionStyles:c}=rl(e),{elevationClasses:d}=xl(e),{roundedClasses:v}=ml(e),{children:p,open:m,parents:f,select:g,getPath:h}=mr(e,n,()=>e.returnObject),y=t.toRef(()=>e.lines?`v-list--${e.lines}-line`:void 0),V=t.toRef(()=>e.activeColor),w=t.toRef(()=>e.baseColor),S=t.toRef(()=>e.color),k=t.toRef(()=>e.selectable||e.activatable)
...
return t.createVNode(e.tag,{ref:N,class:t.normalizeClass(["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},o.value,r.value,s.value,u.value,d.value,y.value,v.value,e.class]),style:t.normalizeStyle([{"--v-list-indent":b(a),"--v-list-group-prepend":a?"0px":void 0,"--v-list-prepend-gap":b(e.prependGap)},i.value,c.value,e.style]),tabindex:e.disabled?-1:0,role:k.value?"listbox":"list","aria-activedescendant":void 0,onFocusin:C,onFocusout:E,onFocus:I,onKeydown:_,onMousedown:P},{default:()=>[t.createVNode(Er,{items:n.value,returnObject:e.returnObject},l)]})}),{open:m,select:g,focus:A,children:p,parents:f,getPath:h}}}),zr=St("v-list-img"),Lr=vt({start:Boolean,end:Boolean,...pt(),...Pa()},"VListItemAction"),Or=wt()({name:"VListItemAction",props:Lr(),setup(e,a){let{slots:l}=a
...
return Object.assign(n.value,{"--v-overlay-anchor-origin":`${h.anchor.side} ${h.anchor.align}`,transformOrigin:`${h.origin.side} ${h.origin.align}`,top:b(Kr(w)),left:e.isRtl.value?void 0:b(Kr(V)),right:e.isRtl.value?b(Kr(-V)):void 0,minWidth:b("y"===N?Math.min(i.value,g.width):i.value),maxWidth:b(qr(F(S.x,i.value===1/0?0:i.value,u.value))),maxHeight:b(qr(F(S.y,s.value===1/0?0:s.value,c.value)))}),{available:S,contentBox:t,flipped:k}}return t.watch(e.target,(e,t)=>{t&&!Array.isArray(t)&&f.unobserve(t),Array.isArray(e)?kt(e,t)||h():e&&f.observe(e)},{immediate:!0}),t.watch(e.contentEl,(e,t)=>{t&&f.unobserve(t),e&&f.observe(e)},{immediate:!0}),t.onScopeDispose(()=>{f.disconnect()}),t.watch(()=>[o.value,r.value,a.offset,a.minWidth,a.minHeight,a.maxWidth,a.maxHeight],()=>h()),t.nextTick(()=>{const e=h()
if(!e)return
...
function $(t){r("click:outside",t),e.persistent?H():v.value=!1}function M(t){return v.value&&w.value&&(!e.scrim||t.target===u.value||t instanceof MouseEvent&&t.shadowTarget===u.value)}function z(t){"Escape"===t.key&&V.value&&(c.value?.contains(document.activeElement)||r("keydown",t),e.persistent?H():(v.value=!1,c.value?.contains(document.activeElement)&&k.value?.focus()))}function L(e){("Escape"!==e.key||V.value)&&r("keydown",e)}!function(e,a){if(!o)return
let l
...
const T=t.computed(()=>({isActive:g,isFocused:u,controlRef:N,blur:v,focus:d}))
...
n.trimStart().length===l.value.length&&(e=n.length-l.value.length),null!=o&&(l.selectionStart=o-e),null!=i&&(l.selectionEnd=i-e)})}return Bt(()=>{const a=!!(o.counter||!1!==e.counter&&null!=e.counter),n=!(!a&&!o.details),[k,x]=T(l),{modelValue:N,...C}=yo.filterProps(e),E=$i.filterProps(e)
return t.createVNode(yo,t.mergeProps({ref:m,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-text-field",{"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-input--plain-underlined":p.value},e.class],style:e.style},k,C,{centerAffix:!p.value,focused:i.value}),{...o,default:a=>{let{id:l,isDisabled:n,isDirty:d,isReadonly:v,isValid:p,hasDetails:m,reset:k}=a
return t.createVNode($i,t.mergeProps({ref:f,onMousedown:V,onClick:w,"onClick:clear":a=>function(a,l){a.stopPropagation(),b(),t.nextTick(()=>{l(),J(e["onClick:clear"],a)})}(a,k),role:e.role},I(E,["onClick:clear"]),{id:l.value,labelId:`${l.value}-label`,active:y.value||d.value,dirty:d.value||e.dirty,disabled:n.value,focused:i.value,details:m.value,error:!1===p.value}),{...o,default:a=>{let{props:{class:i,...d},controlRef:p}=a
const m=t.createElementVNode("input",t.mergeProps({ref:e=>g.value=p.value=e,value:r.value,onInput:S,autofocus:e.autofocus,readonly:v.value,disabled:n.value,name:h.fieldName.value,autocomplete:h.fieldAutocomplete.value,placeholder:e.placeholder,size:1,role:e.role,type:e.type,onFocus:s,onBlur:u,"aria-labelledby":`${l.value}-label`},d,x),null)
...
V.value=Math.max(V.value,performance.now()-e)},V),x=t.watch(g,e=>{e&&(x(),v=d.value.offsetTop,k.immediate(),T(),~w&&t.nextTick(()=>{o&&window.requestAnimationFrame(()=>{$(w),w=-1})}))})
...
return t.watch(a,()=>{y=Array.from({length:a.value.length}),b=Array.from({length:a.value.length}),k.immediate(),T()},{deep:1}),{calculateVisibleItems:T,containerRef:c,markerRef:d,computedItems:M,paddingTop:s,paddingBottom:u,scrollToIndex:$,handleScroll:function(){if(!c.value||!d.value)return
...
return e.multiple?a:a[0]??null}),p=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(v.value):"number"==typeof e.counterValue?e.counterValue:v.value.length),m=po(e),f=zi(e),g=t.computed(()=>v.value.map(e=>e.value)),h=t.shallowRef(!1),y=t.toRef(()=>e.closableChips&&!m.isReadonly.value&&!m.isDisabled.value)
let b,V="",w=0
const S=t.computed(()=>e.hideSelected?u.value.filter(t=>!v.value.some(a=>(e.valueComparator||kt)(a,t))):u.value),k=t.computed(()=>e.hideNoData&&!S.value.length||m.isReadonly.value||m.isDisabled.value),x=la(e,"menu"),N=t.computed({get:()=>x.value,set:e=>{x.value&&!e&&i.value?.ΨopenChildren.size||e&&k.value||(x.value=e)}}),{menuId:C,ariaExpanded:E,ariaControls:I}=Qi(0,N),_=t.computed(()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}})),P=t.ref(),A=Xi(P,r)
function R(t){e.openOnClear&&(N.value=!0)}function T(){k.value||(N.value=!N.value)}function D(e){ue(e)&&F(e)}function F(t){if(!t.key||m.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"," "].includes(t.key)&&(N.value=!0),["Escape","Tab"].includes(t.key)&&(N.value=!1),"Home"===t.key?P.value?.focus("first"):"End"===t.key&&P.value?.focus("last")
if(!ue(t))return
...
if(!o)return
const[r,i]=o
w=i,P.value?.focus(i),e.multiple||(v.value=[r])}function $(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
v.value=e?[a]:[],t.nextTick(()=>{N.value=!1})}}function M(e){P.value?.$el.contains(e.relatedTarget)||(N.value=!1)}function z(){e.eager&&s.value?.calculateVisibleItems()}function L(){h.value&&r.value?.focus()}function O(e){h.value=!0}function j(e){if(null==e)v.value=[]
else if(oe(r.value,":autofill")||oe(r.value,":-webkit-autofill")){const t=u.value.find(t=>t.title===e)
t&&$(t)}else r.value&&(r.value.value="")}return t.watch(N,()=>{if(!e.hideSelected&&N.value&&v.value.length){const t=S.value.findIndex(t=>v.value.some(a=>(e.valueComparator||kt)(a.value,t.value)))
o&&!e.noAutoScroll&&window.requestAnimationFrame(()=>{t>=0&&s.value?.scrollToIndex(t)})}}),t.watch(u,(t,a)=>{N.value||h.value&&e.hideNoData&&!a.length&&t.length&&(N.value=!0)}),Bt(()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||S.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),c=v.value.length>0,d=Hi.filterProps(e),m=c||!h.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
return t.createVNode(Hi,t.mergeProps({ref:r},d,{modelValue:v.value.map(e=>e.props.title).join(", "),name:void 0,"onUpdate:modelValue":j,focused:h.value,"onUpdate:focused":e=>h.value=e,validationValue:v.externalValue,counterValue:p.value,dirty:c,class:["v-select",{"v-select--active-menu":N.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":v.value.length,"v-select--selection-slot":!!l.selection},e.class],style:e.style,inputmode:"none",placeholder:m,"onClick:clear":R,"onMousedown:control":T,onBlur:M,onKeydown:F,"aria-expanded":E.value,"aria-controls":I.value}),{...l,default:r=>{let{id:c}=r
return t.createElementVNode(t.Fragment,null,[t.createElementVNode("select",{hidden:!0,multiple:e.multiple,name:f.fieldName.value},[u.value.map(e=>t.createElementVNode("option",{key:e.value,value:e.value,selected:g.value.includes(e.value)},null))]),t.createVNode(Pi,t.mergeProps({id:C.value,ref:i,modelValue:N.value,"onUpdate:modelValue":e=>N.value=e,activator:"parent",contentClass:"v-select__content",disabled:k.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:z,onAfterLeave:L},_.value),{default:()=>[o&&t.createVNode(Mr,t.mergeProps({ref:P,selected:g.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:D,onFocusin:O,tabindex:"-1",selectable:!0,"aria-live":"polite","aria-labelledby":`${c.value}-label`,"aria-multiselectable":e.multiple,color:e.itemColor??e.color},A,e.listProps),{default:()=>[l["prepend-item"]?.(),!S.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(kr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(qi,{ref:s,renderless:!0,items:S.value,itemKey:"value"},{default:a=>{let{item:n,index:o,itemRef:r}=a
const i=function(e){const a={}
for(const l in e)a[t.camelize(l)]=e[l]
return a}(n.props),s=t.mergeProps(n.props,{ref:r,key:n.value,onClick:()=>$(n,null),"aria-posinset":o+1,"aria-setsize":S.value.length})
return"divider"===n.type?l.divider?.({props:n.raw,index:o})??t.createVNode(Jo,t.mergeProps(n.props,{key:`divider-${o}`}),null):"subheader"===n.type?l.subheader?.({props:n.raw,index:o})??t.createVNode(Nr,t.mergeProps(n.props,{key:`subheader-${o}`}),null):l.item?.({item:n,index:o,props:s})??t.createVNode(kr,t.mergeProps(s,{role:"option"}),{prepend:a=>{let{isSelected:l}=a
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(no,{key:n.value,modelValue:l,ripple:!1,tabindex:"-1","aria-hidden":!0,onClick:e=>e.preventDefault()},null):void 0,i.prependAvatar&&t.createVNode(Kn,{image:i.prependAvatar},null),i.prependIcon&&t.createVNode(Jl,{icon:i.prependIcon},null)])}})}}),l["append-item"]?.()]})]}),v.value.map((n,o)=>{function r(e){e.stopPropagation(),e.preventDefault(),$(n,!1)}const i=t.mergeProps(Xo.filterProps(n.props),{"onClick:close":r,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),r(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0}),s=a?!!l.chip:!!l.selection,u=s?re(a?l.chip({item:n,index:o,props:i}):l.selection({item:n,index:o})):void 0
...
return t.createElementVNode(t.Fragment,null,[l["append-inner"]?.(...n),e.menuIcon?t.createVNode(Jl,{class:"v-select__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon,"aria-hidden":!0},null):void 0])}})}),wo({isFocused:h,menu:N,select:$},r)}}),as=(e,t,a)=>{if(null==e||null==t)return-1
...
return e.multiple?a:a[0]??null}),w=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:V.value.length),S=po(e),{filteredItems:k,getMatches:x}=os(e,m,()=>p.value??(s.value?"":b.value)),N=t.computed(()=>e.hideSelected&&null===p.value?k.value.filter(e=>!V.value.some(t=>t.value===e.value)):k.value),C=t.toRef(()=>e.closableChips&&!S.isReadonly.value&&!S.isDisabled.value),E=t.computed(()=>!(!e.chips&&!l.chip)),I=t.computed(()=>E.value||!!l.selection),_=t.computed(()=>V.value.map(e=>e.props.value)),P=t.computed(()=>N.value.find(e=>"item"===e.type&&!e.props.disabled)),A=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&b.value===P.value?.title)&&N.value.length>0&&!s.value&&!u.value),R=t.computed(()=>e.hideNoData&&!N.value.length||S.isReadonly.value||S.isDisabled.value),T=la(e,"menu"),D=t.computed({get:()=>T.value,set:e=>{T.value&&!e&&c.value?.ΨopenChildren.size||e&&R.value||(T.value=e)}}),{menuId:F,ariaExpanded:$,ariaControls:M}=Qi(0,D),z=t.ref(),L=Xi(z,r)
function O(t){e.openOnClear&&(D.value=!0),b.value=""}function j(){R.value||(D.value=!0)}function H(e){R.value||(i.value&&(e.preventDefault(),e.stopPropagation()),D.value=!D.value)}function W(e){(ue(e)||"Backspace"===e.key)&&r.value?.focus()}function Y(t){if(S.isReadonly.value)return
const a=r.value?.selectionStart,l=V.value.length
if(["Enter","ArrowDown","ArrowUp"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(D.value=!0),["Escape"].includes(t.key)&&(D.value=!1),A.value&&["Enter","Tab"].includes(t.key)&&P.value&&!V.value.some(e=>{let{value:t}=e
return t===P.value.value})&&J(P.value),"ArrowDown"===t.key&&A.value&&z.value?.focus("next"),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&I.value&&V.value.length>0&&!b.value)return J(V.value[0],!1)
if(~v.value){t.preventDefault()
const e=v.value
J(V.value[v.value],!1),v.value=e>=l-1?l-2:e}else"Backspace"!==t.key||b.value||(v.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(v.value<0&&a&&a>0)return
...
const e=v.value+1
V.value[e]?v.value=e:(v.value=-1,r.value?.setSelectionRange(0,0))}else~v.value&&ue(t)&&(v.value=-1)}function U(e){if(oe(r.value,":autofill")||oe(r.value,":-webkit-autofill")){const t=m.value.find(t=>t.title===e.target.value)
t&&J(t)}}function G(){e.eager&&d.value?.calculateVisibleItems()}function K(){i.value&&(s.value=!0,r.value?.focus()),p.value=null}function q(e){i.value=!0,setTimeout(()=>{u.value=!0})}function X(e){u.value=!1}function Z(t){null!=t&&(""!==t||e.multiple||I.value)||(V.value=[])}const Q=t.shallowRef(!1)
...
V.value=e?[a]:[],p.value=s.value?"":b.value??"",b.value=e&&!I.value?a.title:"",t.nextTick(()=>{D.value=!1,s.value=!0})}}return t.watch(i,(a,l)=>{a!==l&&(a?(Q.value=!0,b.value=e.multiple||I.value?"":String(V.value.at(-1)?.props.title??""),s.value=!0,t.nextTick(()=>Q.value=!1)):(e.multiple||null!=b.value||(V.value=[]),D.value=!1,!s.value&&b.value&&(p.value=b.value),b.value="",v.value=-1))}),t.watch(b,e=>{i.value&&!Q.value&&(e&&(D.value=!0),s.value=!e)}),t.watch(D,t=>{if(!e.hideSelected&&t&&V.value.length&&s.value){const e=N.value.findIndex(e=>V.value.some(t=>e.value===t.value))
o&&window.requestAnimationFrame(()=>{e>=0&&d.value?.scrollToIndex(e)})}t&&(p.value=null)}),t.watch(m,(e,t)=>{D.value||i.value&&!t.length&&e.length&&(D.value=!0)}),Bt(()=>{const a=!!(!e.hideNoData||N.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),o=V.value.length>0,u=Hi.filterProps(e)
return t.createVNode(Hi,t.mergeProps({ref:r},u,{modelValue:b.value,"onUpdate:modelValue":[e=>b.value=e,Z],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:V.externalValue,counterValue:w.value,dirty:o,onChange:U,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":D.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!I.value,"v-autocomplete--selecting-index":v.value>-1},e.class],style:e.style,readonly:S.isReadonly.value,placeholder:o?void 0:e.placeholder,"onClick:clear":O,"onMousedown:control":j,onKeydown:Y,"aria-expanded":$.value,"aria-controls":M.value}),{...l,default:o=>{let{id:r}=o
return t.createElementVNode(t.Fragment,null,[t.createVNode(Pi,t.mergeProps({id:F.value,ref:c,modelValue:D.value,"onUpdate:modelValue":e=>D.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:R.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,onAfterEnter:G,onAfterLeave:K},e.menuProps),{default:()=>[a&&t.createVNode(Mr,t.mergeProps({ref:z,filterable:!0,selected:_.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:W,onFocusin:q,onFocusout:X,tabindex:"-1",selectable:!0,"aria-live":"polite","aria-labelledby":`${r.value}-label`,"aria-multiselectable":e.multiple,color:e.itemColor??e.color},L,e.listProps),{default:()=>[l["prepend-item"]?.(),!N.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(kr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(qi,{ref:d,renderless:!0,items:N.value,itemKey:"value"},{default:a=>{let{item:n,index:o,itemRef:r}=a
const i=t.mergeProps(n.props,{ref:r,key:n.value,active:!(!A.value||n!==P.value)||void 0,onClick:()=>J(n,null),"aria-posinset":o+1,"aria-setsize":N.value.length})
return"divider"===n.type?l.divider?.({props:n.raw,index:o})??t.createVNode(Jo,t.mergeProps(n.props,{key:`divider-${o}`}),null):"subheader"===n.type?l.subheader?.({props:n.raw,index:o})??t.createVNode(Nr,t.mergeProps(n.props,{key:`subheader-${o}`}),null):l.item?.({item:n,index:o,props:i})??t.createVNode(kr,t.mergeProps(i,{role:"option"}),{prepend:a=>{let{isSelected:l}=a
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(no,{key:n.value,modelValue:l,ripple:!1,tabindex:"-1","aria-hidden":!0,onClick:e=>e.preventDefault()},null):void 0,n.props.prependAvatar&&t.createVNode(Kn,{image:n.props.prependAvatar},null),n.props.prependIcon&&t.createVNode(Jl,{icon:n.props.prependIcon},null)])},title:()=>s.value?n.title:rs("v-autocomplete",n.title,x(n)?.title)})}}),l["append-item"]?.()]})]}),V.value.map((a,n)=>{function o(e){e.stopPropagation(),e.preventDefault(),J(a,!1)}const r=t.mergeProps(Xo.filterProps(a.props),{"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0}),i=E.value?!!l.chip:!!l.selection,s=i?re(E.value?l.chip({item:a,index:n,props:r}):l.selection({item:a,index:n})):void 0
if(!i||s)return t.createElementVNode("div",{key:a.value,class:t.normalizeClass(["v-autocomplete__selection",n===v.value&&["v-autocomplete__selection--selected",h.value]]),style:t.normalizeStyle(n===v.value?y.value:{})},[E.value?l.chip?t.createVNode(nl,{key:"chip-defaults",defaults:{VChip:{closable:C.value,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(Xo,t.mergeProps({key:"chip",closable:C.value,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createElementVNode("span",{class:"v-autocomplete__selection-text"},[a.title,e.multiple&&n<V.value.length-1&&t.createElementVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])})])},"append-inner":function(){for(var a=arguments.length,n=new Array(a),o=0;o<a;o++)n[o]=arguments[o]
return t.createElementVNode(t.Fragment,null,[l["append-inner"]?.(...n),e.menuIcon?t.createVNode(Jl,{class:"v-autocomplete__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon,onMousedown:H,onClick:ne,"aria-hidden":!0,tabindex:"-1"},null):void 0])}})}),wo({isFocused:i,isPristine:s,menu:D,search:b,filteredItems:k,select:J},r)}}),us=vt({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Dt,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...pt(),...nn({location:"top end"}),...pl(),...Pa(),...ya(),...fl({transition:"scale-rotate-transition"}),...ol()},"VBadge"),cs=wt()({name:"VBadge",inheritAttrs:!1,props:us(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:n}=dl(()=>e.color),{roundedClasses:o}=ml(e),{t:r}=ma(),{textColorClasses:i,textColorStyles:s}=cl(()=>e.textColor),{themeClasses:u}=Ea(),{locationStyles:c}=on(e,!0,t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?Number(e.offsetY??0):["left","right"].includes(t)?Number(e.offsetX??0):0)),{dimensionStyles:d}=rl(e)
...
return t.withDirectives(t.createElementVNode("div",t.mergeProps(n.getColorProps({text:p,background:m}),C,s,{ref_for:!0,ref:g}),[u?.(N)??w(x)]),[[Dn,e.eventRipple??!0]])}function w(e){return t.createElementVNode("div",{class:"pl-1"},[e()])}function S(a){const l=(e.eventHeight||0)+(e.eventMarginBottom||0)
...
const{min:s,max:u,thumbColor:c,thumbLabelColor:d,step:v,disabled:p,thumbSize:m,thumbLabel:f,direction:g,isReversed:h,vertical:y,readonly:V,elevation:w,mousePressed:S,decimals:x,indexFromEnd:N}=o,C=t.computed(()=>p.value?void 0:w.value),{elevationClasses:E}=xl(C),{textColorClasses:I,textColorStyles:_}=cl(c),{backgroundColorClasses:P,backgroundColorStyles:A}=dl(d),{pageup:R,pagedown:T,end:B,home:D,left:F,right:$,down:M,up:z}=k,L=[R,T,B,D,F,$,M,z],O=t.computed(()=>v.value?[1,2,3]:[1,5,10])
...
b.value||V.value||(u.value=p(t))},getActiveThumb:()=>o.value?.$el}),{isFocused:S,focus:k,blur:x}=uo(e),N=t.computed(()=>h(u.value))
return Bt(()=>{const a=yo.filterProps(e),n=!!(e.label||l.label||l.prepend)
return t.createVNode(yo,t.mergeProps({ref:r,class:["v-slider",{"v-slider--has-labels":!!l["tick-label"]||y.value,"v-slider--focused":S.value,"v-slider--pressed":v.value,"v-slider--disabled":b.value},i.value,e.class],style:e.style},a,{focused:S.value}),{...l,prepend:n?a=>t.createElementVNode(t.Fragment,null,[l.label?.(a)??(e.label?t.createVNode(Xn,{id:a.id.value,class:"v-slider__label",text:e.label},null):void 0),l.prepend?.(a)]):void 0,default:a=>{let{id:n,messagesId:r}=a
return t.createElementVNode("div",{class:"v-slider__container",onMousedown:V.value?void 0:m,onTouchstartPassive:V.value?void 0:f},[t.createElementVNode("input",{id:n.value,name:e.name||n.value,disabled:b.value,readonly:V.value,tabindex:"-1",value:u.value},null),t.createVNode(ed,{ref:g,start:0,stop:N.value},{"tick-label":l["tick-label"]}),t.createVNode(Qc,{ref:o,"aria-describedby":r.value,focused:S.value,noKeyboard:w.value,min:c.value,max:d.value,modelValue:u.value,"onUpdate:modelValue":e=>u.value=e,position:N.value,elevation:e.elevation,onFocus:k,onBlur:x,ripple:e.ripple,name:e.name},{"thumb-label":l["thumb-label"]})])}})}),wo({focus:()=>o.value?.$el.focus()},r)}}),ld=vt({color:{type:Object},disabled:Boolean,hideAlpha:Boolean,hideEyeDropper:Boolean,eyeDropperIcon:{type:Dt,default:"$eyeDropper"},...pt()},"VColorPickerPreview"),nd=Vt({name:"VColorPickerPreview",props:ld(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
return e.multiple?a:a[0]??null}),w=po(e),S=t.toRef(()=>e.closableChips&&!w.isReadonly.value&&!w.isDisabled.value),k=t.computed(()=>!(!e.chips&&!n.chip)),x=t.computed(()=>k.value||!!n.selection),N=t.shallowRef(e.multiple||x.value?"":V.value[0]?.title??""),C=t.shallowRef(null),E=t.computed({get:()=>N.value,set:async a=>{if(N.value=a??"",null===a||""===a&&!e.multiple&&!x.value?V.value=[]:e.multiple||x.value||(V.value=[Pr(e,a)],t.nextTick(()=>v.value?.scrollToIndex(0))),a&&e.multiple&&e.delimiters?.length){const e=ee(a)
e.length>1&&(te(e),N.value="")}a||(p.value=-1),u.value=!a}}),I=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?V.value.length:E.value.length),{filteredItems:_,getMatches:P}=os(e,f,()=>C.value??(e.alwaysFilter||!u.value?E.value:"")),A=t.computed(()=>e.hideSelected&&null===C.value?_.value.filter(e=>!V.value.some(t=>t.value===e.value)):_.value),T=t.computed(()=>e.hideNoData&&!A.value.length||w.isReadonly.value||w.isDisabled.value),D=la(e,"menu"),F=t.computed({get:()=>D.value,set:e=>{D.value&&!e&&d.value?.ΨopenChildren.size||e&&T.value||(D.value=e)}}),{menuId:$,ariaExpanded:M,ariaControls:z}=Qi(0,F)
t.watch(N,e=>{m?t.nextTick(()=>m=!1):s.value&&!F.value&&(F.value=!0),l("update:search",e)}),t.watch(V,t=>{e.multiple||x.value||(N.value=t[0]?.title??"")})
const L=t.computed(()=>V.value.map(e=>e.value)),O=t.computed(()=>A.value.find(e=>"item"===e.type&&!e.props.disabled)),j=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&E.value===O.value?.title)&&A.value.length>0&&!u.value&&!c.value),H=t.ref(),W=Xi(H,i)
function Y(a){m=!0,t.nextTick(()=>m=!1),e.openOnClear&&(F.value=!0)}function U(){T.value||(F.value=!0)}function G(e){T.value||(s.value&&(e.preventDefault(),e.stopPropagation()),F.value=!F.value)}function K(e){(ue(e)||"Backspace"===e.key)&&i.value?.focus()}function q(t){if(function(e){return e.isComposing&&R.includes(e.key)}(t)||w.isReadonly.value)return
const a=i.value?.selectionStart,l=V.value.length
if(["Enter","ArrowDown","ArrowUp"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(F.value=!0),["Escape"].includes(t.key)&&(F.value=!1),j.value&&["Enter","Tab"].includes(t.key)&&O.value&&!V.value.some(e=>{let{value:t}=e
return t===O.value.value})&&J(O.value),"ArrowDown"===t.key&&j.value&&H.value?.focus("next"),"Enter"===t.key&&E.value&&(J(Pr(e,E.value),!0,!0),x.value&&(N.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&x.value&&V.value.length>0&&!E.value)return J(V.value[0],!1)
if(~p.value){t.preventDefault()
const e=p.value
J(V.value[p.value],!1),p.value=e>=l-1?l-2:e}else"Backspace"!==t.key||E.value||(p.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(p.value<0&&a&&a>0)return
const e=p.value>-1?p.value-1:l-1
V.value[e]?p.value=e:(p.value=-1,i.value?.setSelectionRange(E.value.length,E.value.length))}else if("ArrowRight"===t.key){if(p.value<0)return
const e=p.value+1
V.value[e]?p.value=e:(p.value=-1,i.value?.setSelectionRange(0,0))}else~p.value&&ue(t)&&(p.value=-1)}function X(t){const a=ee(t?.clipboardData?.getData("Text")??"")
a.length>1&&e.multiple&&(t.preventDefault(),te(a))}function Z(){e.eager&&v.value?.calculateVisibleItems()}function Q(){s.value&&i.value?.focus(),u.value=!0,C.value=null}function J(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=arguments.length>2&&void 0!==arguments[2]&&arguments[2]
if(a&&!a.props.disabled)if(e.multiple){const t=V.value.findIndex(t=>(e.valueComparator||kt)(t.value,a.value)),n=null==l?!~t:l
if(~t){const e=n?[...V.value,a]:[...V.value]
e.splice(t,1),V.value=e}else n&&(V.value=[...V.value,a])
e.clearOnSelect&&(E.value="")}else{const o=!1!==l
V.value=o?[a]:[],u.value&&!e.alwaysFilter||!N.value||(C.value=N.value),N.value=o&&!x.value?a.title:"",t.nextTick(()=>{F.value=n,u.value=!0})}}function ee(t){const a=["\n",...e.delimiters??[]].map(de).join("|")
return t.split(new RegExp(`(?:${a})+`))}async function te(a){for(let l of a)l=l.trim(),l&&(J(Pr(e,l)),await t.nextTick())}function ae(e){s.value=!0,setTimeout(()=>{c.value=!0})}function le(e){c.value=!1}return t.watch(s,(t,a)=>{if(!t&&t!==a&&(p.value=-1,F.value=!1,E.value)){if(e.multiple)return void J(Pr(e,E.value))
if(!x.value)return
V.value.some(e=>{let{title:t}=e
return t===E.value})?N.value="":J(Pr(e,E.value))}}),t.watch(F,t=>{if(!e.hideSelected&&t&&V.value.length&&u.value){const t=A.value.findIndex(t=>V.value.some(a=>(e.valueComparator||kt)(a.value,t.value)))
o&&window.requestAnimationFrame(()=>{t>=0&&v.value?.scrollToIndex(t)})}t&&(C.value=null)}),t.watch(f,(e,t)=>{F.value||s.value&&!t.length&&e.length&&(F.value=!0)}),Bt(()=>{const a=!!(!e.hideNoData||A.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),l=V.value.length>0,o=Hi.filterProps(e)
return t.createVNode(Hi,t.mergeProps({ref:i},o,{modelValue:E.value,"onUpdate:modelValue":e=>E.value=e,focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:V.externalValue,counterValue:I.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":F.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!x.value,"v-combobox--selecting-index":p.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:w.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":Y,"onMousedown:control":U,onKeydown:q,onPaste:X,"aria-expanded":M.value,"aria-controls":z.value}),{...n,default:l=>{let{id:o}=l
return t.createElementVNode(t.Fragment,null,[t.createVNode(Pi,t.mergeProps({id:$.value,ref:d,modelValue:F.value,"onUpdate:modelValue":e=>F.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:T.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,onAfterEnter:Z,onAfterLeave:Q},e.menuProps),{default:()=>[a&&t.createVNode(Mr,t.mergeProps({ref:H,filterable:!0,selected:L.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),selectable:!0,onKeydown:K,onFocusin:ae,onFocusout:le,tabindex:"-1","aria-live":"polite","aria-labelledby":`${o.value}-label`,"aria-multiselectable":e.multiple,color:e.itemColor??e.color},W,e.listProps),{default:()=>[n["prepend-item"]?.(),!A.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(kr,{key:"no-data",title:r(e.noDataText)},null)),t.createVNode(qi,{ref:v,renderless:!0,items:A.value,itemKey:"value"},{default:a=>{let{item:l,index:o,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,active:!(!j.value||l!==O.value)||void 0,onClick:()=>J(l,null),"aria-posinset":o+1,"aria-setsize":A.value.length})
return"divider"===l.type?n.divider?.({props:l.raw,index:o})??t.createVNode(Jo,t.mergeProps(l.props,{key:`divider-${o}`}),null):"subheader"===l.type?n.subheader?.({props:l.raw,index:o})??t.createVNode(Nr,t.mergeProps(l.props,{key:`subheader-${o}`}),null):n.item?.({item:l,index:o,props:i})??t.createVNode(kr,t.mergeProps(i,{role:"option"}),{prepend:a=>{let{isSelected:n}=a
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(no,{key:l.value,modelValue:n,ripple:!1,tabindex:"-1","aria-hidden":!0,onClick:e=>e.preventDefault()},null):void 0,l.props.prependAvatar&&t.createVNode(Kn,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Jl,{icon:l.props.prependIcon},null)])},title:()=>u.value?l.title:rs("v-combobox",l.title,P(l)?.title)})}}),n["append-item"]?.()]})]}),V.value.map((a,l)=>{function o(e){e.stopPropagation(),e.preventDefault(),J(a,!1)}const r=t.mergeProps(Xo.filterProps(a.props),{"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0}),i=k.value?!!n.chip:!!n.selection,s=i?re(k.value?n.chip({item:a,index:l,props:r}):n.selection({item:a,index:l})):void 0
if(!i||s)return t.createElementVNode("div",{key:a.value,class:t.normalizeClass(["v-combobox__selection",l===p.value&&["v-combobox__selection--selected",y.value]]),style:t.normalizeStyle(l===p.value?b.value:{})},[k.value?n.chip?t.createVNode(nl,{key:"chip-defaults",defaults:{VChip:{closable:S.value,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(Xo,t.mergeProps({key:"chip",closable:S.value,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createElementVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&l<V.value.length-1&&t.createElementVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])})])},"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createElementVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(Jl,{class:"v-combobox__menu-icon",color:i.value?.fieldIconColor,icon:e.menuIcon,onMousedown:G,onClick:ne,"aria-hidden":!0,tabindex:"-1"},null)])}})}),wo({isFocused:s,isPristine:u,menu:F,search:E,selectionIndex:p,filteredItems:_,select:J},i)}}),gd=vt({modelValue:null,color:String,cancelText:{type:String,default:"$vuetify.confirmEdit.cancel"},okText:{type:String,default:"$vuetify.confirmEdit.ok"},disabled:{type:[Boolean,Array],default:void 0},hideActions:Boolean},"VConfirmEdit"),hd=wt()({name:"VConfirmEdit",props:gd(),emits:{cancel:()=>!0,save:e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return e}const Sd=vt({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),kd=Symbol.for("vuetify:data-table-group")
...
return t.provide(kd,i),i}function Cd(){const e=t.inject(kd)
...
let s=null
t.watch(()=>({page:a.value,itemsPerPage:l.value,sortBy:n.value,groupBy:o.value,search:r.value}),e=>{kt(s,e)||(s&&s.search!==e.search&&(a.value=1),i.emit("update:options",e),s=e)},{deep:!0,immediate:!0})}const Ad=vt({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10}},"DataTable-paginate"),Rd=Symbol.for("vuetify:data-table-pagination")
...
return a}(e,e.items))
return{items:a}}const Qd=vt({search:String,loading:Boolean,...pt(),...qd(),...zd(),...Hd(),...Ad({itemsPerPage:5}),...yd(),...Sd(),...ns(),...Pa(),...fl({transition:{component:Ya,hideOnLeave:!0}})},"VDataIterator"),Jd=wt()({name:"VDataIterator",props:Qd(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const n=la(e,"groupBy"),o=t.toRef(()=>e.search),{items:r}=Zd(e),{filteredItems:i}=os(e,r,o,{transform:e=>e.raw}),{initialSortOrder:s,sortBy:u,multiSort:c,mustSort:d}=Yd(e),{page:v,itemsPerPage:p}=Td(e),{toggleSort:m}=Ud({initialSortOrder:s,sortBy:u,multiSort:c,mustSort:d,page:v}),{sortByWithGroups:f,opened:g,extractRows:h,isGroupOpen:y,toggleGroup:b}=Nd({groupBy:n,sortBy:u}),{sortedItems:V}=Kd(e,i,f,{transform:e=>e.raw}),{flatItems:w}=_d(V,n,g,!1),S=t.toRef(()=>w.value.length),{startIndex:k,stopIndex:x,pageCount:N,prevPage:C,nextPage:E,setItemsPerPage:I,setPage:_}=Bd({page:v,itemsPerPage:p,itemsLength:S}),{paginatedItems:P}=Dd({items:w,startIndex:k,stopIndex:x,itemsPerPage:p}),A=t.computed(()=>h(P.value)),{isSelected:R,select:T,selectAll:B,toggleSelect:D}=Od(e,{allItems:r,currentPage:A}),{isExpanded:F,toggleExpand:$}=Vd(e)
...
return o.value?t.createElementVNode(t.Fragment,null,[t.createElementVNode("div",{class:"v-data-table__td-title"},[l[b]?.(w)??a.title]),t.createElementVNode("div",{class:"v-data-table__td-value"},[l[y]?.(V)??n])]):n}})})]))}}),Ev=vt({color:String,loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...C(Nv(),["collapseIcon","expandIcon","density"]),...C(kv(),["groupCollapseIcon","groupExpandIcon","density"]),...Ao()},"VDataTableRows"),Iv=wt()({name:"VDataTableRows",inheritAttrs:!1,props:Ev(),setup(e,a){let{attrs:l,slots:n}=a
...
return{type:"item",key:e.returnObject?h(t,e.itemValue):n,index:a,value:n,selectable:o,columns:r,raw:t}}(e,t,l,a))}function Tv(e,a){return{items:t.computed(()=>Rv(e,e.items,a.value))}}const Bv=vt({...Ev(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...yd(),...Sd(),...iv(),...Av(),...zd(),...Hd(),...I(wv(),["multiSort","initialSortOrder"]),..._v()},"DataTable"),Dv=vt({...Ad(),...Bv(),...ns(),...av()},"VDataTable"),Fv=wt()({name:"VDataTable",props:Dv(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{groupBy:o}=xd(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Yd(e),{page:c,itemsPerPage:d}=Td(e),{disableSort:v}=t.toRefs(e),{columns:p,headers:m,sortFunctions:f,sortRawFunctions:g,filterFunctions:h}=bv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:y}=Tv(e,p),b=t.toRef(()=>e.search),{filteredItems:V}=os(e,y,b,{transform:e=>e.columns,customKeyFilter:h}),{toggleSort:w}=Ud({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u,page:c}),{sortByWithGroups:S,opened:k,extractRows:x,isGroupOpen:N,toggleGroup:C}=Nd({groupBy:o,sortBy:i,disableSort:v}),{sortedItems:E}=Kd(e,V,S,{transform:e=>({...e.raw,...e.columns}),sortFunctions:f,sortRawFunctions:g}),{flatItems:_}=_d(E,o,k,()=>!!n["group-summary"]),P=t.computed(()=>_.value.length),{startIndex:A,stopIndex:R,pageCount:T,setItemsPerPage:B}=Bd({page:c,itemsPerPage:d,itemsLength:P}),{paginatedItems:D}=Dd({items:_,startIndex:A,stopIndex:R,itemsPerPage:d}),F=t.computed(()=>x(D.value)),{isSelected:$,select:M,selectAll:z,toggleSelect:L,someSelected:O,allSelected:j}=Od(e,{allItems:y,currentPage:F}),{isExpanded:H,toggleExpand:W}=Vd(e)
...
const{groupBy:o}=xd(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Yd(e),{page:c,itemsPerPage:d}=Td(e),{disableSort:v}=t.toRefs(e),p=t.computed(()=>parseInt(e.itemsLength,10)),{columns:m,headers:f}=bv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:g}=Tv(e,m),{toggleSort:h}=Ud({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u,page:c}),{opened:y,isGroupOpen:b,toggleGroup:V,extractRows:w}=Nd({groupBy:o,sortBy:i,disableSort:v}),{pageCount:S,setItemsPerPage:k}=Bd({page:c,itemsPerPage:d,itemsLength:p}),{flatItems:x}=_d(g,o,y,()=>!!n["group-summary"]),{isSelected:N,select:C,selectAll:E,toggleSelect:_,someSelected:P,allSelected:A}=Od(e,{allItems:g,currentPage:g}),{isExpanded:R,toggleExpand:T}=Vd(e),B=t.computed(()=>w(g.value))
...
return g.value&&!a.isSelected&&(a.isDisabled=!0),t.createElementVNode("div",{class:t.normalizeClass(["v-date-picker-month__day",{"v-date-picker-month__day--adjacent":a.isAdjacent,"v-date-picker-month__day--hide-adjacent":a.isHidden,"v-date-picker-month__day--selected":a.isSelected,"v-date-picker-month__day--week-end":a.isWeekEnd,"v-date-picker-month__day--week-start":a.isWeekStart}]),"data-v-date":a.isDisabled?void 0:a.isoDate},[(e.showAdjacentMonths||!a.isAdjacent)&&(n.day?.(o)??t.createVNode($n,o.props,{default:()=>[a.localized,V(a.isoDate)]}))])})])]})]))}}),kp=vt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,year:Number,allowedMonths:[Array,Function]},"VDatePickerMonths"),xp=wt()({name:"VDatePickerMonths",props:kp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return e.landscape&&3===t.split(" ").length?t.replace(" ","\n"):t}),S=t.toRef(()=>{let e=o.date()
return e=o.setDate(e,1),e=o.setMonth(e,g.value),e=o.setYear(e,y.value),e}),k=t.toRef(()=>o.format(S.value,"monthAndYear")),x=t.toRef(()=>o.format(S.value,"monthShort")),N=t.toRef(()=>o.format(S.value,"year")),C=t.toRef(()=>`date-picker-header${V.value?"-reverse":""}-transition`),E=t.computed(()=>{if(e.disabled)return!0
const t=[]
...
i!==g.value&&(g.value=i,j()),s!==y.value&&(y.value=s,H()),V.value=o.isBefore(n,r)}),Bt(()=>{const a=vd.filterProps(e),l=I(gp.filterProps(e),["viewMode"]),o=yp.filterProps(e),v=Sp.filterProps(e),p=I(xp.filterProps(e),["modelValue"]),f=I(Cp.filterProps(e),["modelValue"]),h={color:m.value,header:w.value,transition:C.value}
return t.createVNode(vd,t.mergeProps(a,{color:m.value,class:["v-date-picker",`v-date-picker--${u.value}`,{"v-date-picker--show-week":e.showWeek},i.value,e.class],style:[{"--v-date-picker-landscape-header-width":b(e.landscapeHeaderWidth)},e.style]}),{title:()=>n.title?.()??t.createElementVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>n.header?t.createVNode(nl,{defaults:{VDatePickerHeader:{...h}}},{default:()=>[n.header?.(h)]}):t.createVNode(yp,t.mergeProps({key:"header"},o,h,{onClick:"month"!==u.value?z:void 0}),{prepend:n.prepend,append:n.append}),default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(gp,t.mergeProps(l,{disabled:E.value,viewMode:u.value,text:k.value,monthText:x.value,yearText:N.value,"onClick:next":D,"onClick:prev":F,"onClick:nextYear":$,"onClick:prevYear":M,"onClick:month":L,"onClick:year":O}),{default:n.controls}),t.createVNode(Ya,{hideOnLeave:!0},{default:()=>["months"===u.value?t.createVNode(xp,t.mergeProps({key:"date-picker-months"},p,{modelValue:g.value,"onUpdate:modelValue":[e=>g.value=e,j],min:c.value,max:d.value,year:y.value,allowedMonths:P.value}),{month:n.month}):"year"===u.value?t.createVNode(Cp,t.mergeProps({key:"date-picker-years"},f,{modelValue:y.value,"onUpdate:modelValue":[e=>y.value=e,H],min:c.value,max:d.value,allowedYears:_.value}),{year:n.year}):t.createVNode(Sp,t.mergeProps({key:"date-picker-month"},v,{modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,month:g.value,"onUpdate:month":[e=>g.value=e,j],year:y.value,"onUpdate:year":[e=>y.value=e,H],min:c.value,max:d.value}),{day:n.day})]})]),actions:n.actions})}),{}}}),_p=vt({actionText:String,bgColor:String,color:String,icon:Dt,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...pt(),...ol(),...Xl({size:void 0}),...ya()},"VEmptyState"),Pp=wt()({name:"VEmptyState",props:_p(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
function N(){b.value!==document.activeElement&&b.value?.focus(),u.value||c()}function C(e){b.value?.click()}function E(e){n("mousedown:control",e)}function I(e){b.value?.click(),n("click:control",e)}function _(a){a.stopPropagation(),N(),t.nextTick(()=>{s.value=[],J(e["onClick:clear"],a)})}function P(e){e.preventDefault(),e.stopImmediatePropagation(),S.value=!0}function A(e){e.preventDefault(),S.value=!1}async function R(e){if(e.preventDefault(),e.stopImmediatePropagation(),S.value=!1,!b.value||!x(e))return
...
o.repack=!0,b.value.dispatchEvent(o)}return t.watch(s,e=>{(!Array.isArray(e)||!e.length)&&b.value&&(b.value.value="")}),Bt(()=>{const a=!(!o.counter&&!e.counter),n=!(!a&&!o.details),[r,i]=T(l),{modelValue:c,...v}=yo.filterProps(e),k={...$i.filterProps(e),"onClick:clear":_},x=void 0!==l.webkitdirectory&&!1!==l.webkitdirectory,B=l.accept?String(l.accept):void 0,F=x?void 0:e.filterByType??B
...
t&&i.value?.submit()}),t.preventDefault()}return Bt(()=>t.createElementVNode("form",{ref:i,class:t.normalizeClass(["v-form",e.class]),style:t.normalizeStyle(e.style),novalidate:!0,onReset:s,onSubmit:u},[n.default?.(r)])),wo(r,i)}}),Qp=vt({color:String,...wl(),...pt(),...pl(),...Pa({tag:"kbd"}),...ya(),...kl()},"VKbd"),Jp=wt()({name:"VKbd",props:Qp(),setup(e,a){let{slots:l}=a
...
return t!==F(t,e.min,e.max)}),y=t.computed(()=>!s.value&&(p.value??0)+e.step<=e.max),b=t.computed(()=>!s.value&&(p.value??0)-e.step>=e.min),V=t.computed(()=>e.hideInput?"stacked":e.controlVariant),w=t.toRef(()=>"split"===V.value?"$plus":"$collapse"),S=t.toRef(()=>"split"===V.value?"$minus":"$expand"),k=t.toRef(()=>"split"===V.value?"default":"small"),x=t.toRef(()=>"stacked"===V.value?"auto":"100%"),N={props:{onClick:A,onPointerup:R,onPointerdown:T,onPointercancel:R}},C={props:{onClick:A,onPointerup:R,onPointerdown:B,onPointercancel:R}}
...
return n<i||n===i&&a<0?o.value.$el:r.value.$el}}),{isFocused:S,focus:k,blur:x}=uo(e),N=t.computed(()=>y(c.value[0])),C=t.computed(()=>y(c.value[1]))
return Bt(()=>{const a=yo.filterProps(e),n=!!(e.label||l.label||l.prepend)
return t.createVNode(yo,t.mergeProps({class:["v-slider","v-range-slider",{"v-slider--has-labels":!!l["tick-label"]||v.value,"v-slider--focused":S.value,"v-slider--pressed":f.value,"v-slider--disabled":V.value},s.value,e.class],style:e.style,ref:i},a,{focused:S.value}),{...l,prepend:n?a=>t.createElementVNode(t.Fragment,null,[l.label?.(a)??(e.label?t.createVNode(Xn,{class:"v-slider__label",text:e.label},null):void 0),l.prepend?.(a)]):void 0,default:a=>{let{id:n,messagesId:i}=a
return t.createElementVNode("div",{class:"v-slider__container",onMousedown:w.value?void 0:g,onTouchstartPassive:w.value?void 0:h},[t.createElementVNode("input",{id:`${n.value}_start`,name:e.name||n.value,disabled:V.value,readonly:w.value,tabindex:"-1",value:c.value[0]},null),t.createElementVNode("input",{id:`${n.value}_stop`,name:e.name||n.value,disabled:V.value,readonly:w.value,tabindex:"-1",value:c.value[1]},null),t.createVNode(ed,{ref:b,start:N.value,stop:C.value},{"tick-label":l["tick-label"]}),t.createVNode(Qc,{ref:o,"aria-describedby":i.value,focused:S&&d.value===o.value?.$el,modelValue:c.value[0],"onUpdate:modelValue":e=>c.value=[e,c.value[1]],onFocus:e=>{k(),d.value=o.value?.$el,p.value!==m.value&&c.value[0]===c.value[1]&&c.value[1]===m.value&&e.relatedTarget!==r.value?.$el&&(o.value?.$el.blur(),r.value?.$el.focus())},onBlur:()=>{x(),d.value=void 0},min:m.value,max:c.value[1],position:N.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]}),t.createVNode(Qc,{ref:r,"aria-describedby":i.value,focused:S&&d.value===r.value?.$el,modelValue:c.value[1],"onUpdate:modelValue":e=>c.value=[c.value[0],e],onFocus:e=>{k(),d.value=r.value?.$el,p.value!==m.value&&c.value[0]===c.value[1]&&c.value[0]===p.value&&e.relatedTarget!==o.value?.$el&&(r.value?.$el.blur(),o.value?.$el.focus())},onBlur:()=>{x(),d.value=void 0},min:c.value[0],max:p.value,position:C.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]})])}})}),wo({focus:()=>o.value?.$el.focus()},i)}}),Gm=vt({name:String,itemAriaLabel:{type:String,default:"$vuetify.rating.ariaLabel.item"},activeColor:String,color:String,clearable:Boolean,disabled:Boolean,emptyIcon:{type:Dt,default:"$ratingEmpty"},fullIcon:{type:Dt,default:"$ratingFull"},halfIncrements:Boolean,hover:Boolean,length:{type:[Number,String],default:5},readonly:Boolean,modelValue:{type:[Number,String],default:0},itemLabels:Array,itemLabelPosition:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},ripple:Boolean,...pt(),...Tl(),...Xl(),...Pa(),...ya()},"VRating"),Km=wt()({name:"VRating",props:Gm(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return Math.sqrt(a*a+l*l)}function P(e){null===s.value&&(s.value=e),u.value=e,S(e)}function A(t){if(t.preventDefault(),!i.value&&"click"!==t.type||!n.value)return
...
null!==t&&t!==e.modelValue&&l("update:modelValue",t),w.value&&l("update:modelValue",null)}function k(){return null==i.value||null==s.value||e.useSeconds&&null==u.value?null:`${sg(i.value)}:${sg(s.value)}`+(e.useSeconds?`:${sg(u.value)}`:"")}function x(e){if(null==e||""===e)i.value=null,s.value=null,u.value=null
...
return((l.find(e=>a((e+t)%l.length+l[0]))||0)+t)%l.length+l[0]}(0,e)}return l("update:period",e),S(),!0}function C(e){"hour"===m.value?i.value=V.value?cg(e,p.value):e:"minute"===m.value?s.value=e:u.value=e}function E(t){switch(m.value||"hour"){case"hour":l("update:hour",t)
break
...
return{mounted:n,updated:n,unmounted(e){t.render(null,e)}}}(kg,e=>({activator:(V(e.value)?!e.value.text:["",!1,null].includes(e.value))?null:"parent",location:e.arg?.replace("-"," "),text:"boolean"==typeof e.value?void 0:e.value}))
...
if(a&&e in a)return a[e]}Wg.version="3.11.3"
const Ug=function(){return Wg({components:Dg,directives:jg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Gg="3.11.3"
